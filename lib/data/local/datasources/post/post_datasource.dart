...
//  Future<Database> get _db async => await AppDatabase.instance.database;
  ...
  Future<List<PostModel>> getAllSortedByFilter({List<Filter>? filters}) async {
    //creating finder
    final finder = Finder(
    ...
    return recordSnapshots.map((snapshot) {
      final post = PostModel.fromJson(snapshot.value);
  ...
  Future<PostListModel> getPostsFromDb() async {
  ...
  Future<int> update(PostModel post) async {
  ...
  Future<int> delete(PostModel post) async {
    final finder = Finder(filter: Filter.byKey(post.id));
